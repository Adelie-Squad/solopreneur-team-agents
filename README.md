...
- VPS + systemd (see [`manual/cloud-deployment.md`](manual/cloud-deployment.md))
...
| **v1.0.0 (released)** | **Formal launch** | Stable API guarantees · 42 CLI surface freeze · `docs/policy/schema-stability.md` 공개 약속 발효 · Discord 단일 메신저 (Slack post-v1.0 슬롯) |
