...
| 버전 | 테마 | 핵심 | 문서 |
|------|------|------|------|
| **v1.1** | 크로스 플랫폼 | Win/Mac/Linux 완전 지원, CI 매트릭스 | `docs/v1.1-cross-platform.md` |
| **v1.2** | 자율 실행 엔진 | program.md → 밤새 자율 작업 → 아침 보고서 | `docs/v1.2-autonomous-engine.md` |
| **v1.3** | 스킬 자유도 | SKILL.md 프론트매터, 3-tier 검색, 자동 라우팅 | `docs/v1.3-skill-freedom.md` |
| **v1.4** | 지식 온톨로지 | 팀/에이전트/프로젝트 3계층 지식 자동 축적 | `docs/v1.4-knowledge-ontology.md` |
| **v1.5** | 웹 대시보드 | Next.js 대시보드, Supabase API 연동 | `docs/v1.5-web-dashboard.md` |
| **v2.0** | 커뮤니티 | 제품 쇼케이스, 피드백, 스킬 마켓플레이스 | (예정) |
| **v3.0** | 코워킹 스페이스 | 가상 오피스, 실시간 협업, AI 팀 시각화 | (예정) |
